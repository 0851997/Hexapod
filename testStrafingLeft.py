...
if ser.isOpen():
    ...
    sleep(0.5)
    while(True):
        ser.write("#30P1477#25P1477#17P1477 #14P1522#9P1522#1P1522 T200\r".encode()) #higher standing stance
        sleep(time)
        ser.write("#25P1177 #9P1822 T200\r".encode()) #Center legs high possition
        sleep(time)
        ser.write("#26P1255 #10P2144 T200\r".encode()) #Center legs 
        sleep(time)
        ser.write("#25P1477 #9P1522 T200\r".encode()) #Center legs high possition
        sleep(time)
        ser.write("#14P1822 #1P1822 T200\r".encode())
        sleep(time)
