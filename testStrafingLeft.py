...
if ser.isOpen():
    ...
    while(True):            #Tripod Gait A is described                        Tripod Gait B is described
        ...
        sleep(time)
        ser.write("#29P1522#16P1477#8P1500 #30P1277#17P1277#9P1722 #10P2144 #0P1922#13P1522#24P1500 #1P1922#14P1922#25P1077 #26P1255  T200\r".encode())
        sleep(time)
        ser.write("#29P1522#16P1477#8P1500 #30P1277#17P1277#9P1722 #10P2144 #0P1922#13P1522#24P1500 #1P1722#14P1722#25P1277 #26P1255  T200\r".encode())
        sleep(time)
        ser.write("#29P1522#16P1477#8P1500 #30P1077#17P1077#9P1922 #10P2144 #0P1922#13P1522#24P1500 #1P1722#14P1722#25P1277 #26P1255  T200\r".encode())
        sleep(time)
