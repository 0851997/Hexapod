...
if ser.isOpen():
    ...
    while(True):
        ...
        ser.write("#30P944#17P944#18P1056#31P1056#29P922#16P644#9P2056#10P1944#8P1200T1000\r".encode())
        sleep(1)
        #down other side A
        ser.write("#31P1166#18P1166#30P1333#17P1333#29P922#16P644#8P1200#9P1666#10P1833T1000\r".encode())
        sleep(1)
        #forward A
