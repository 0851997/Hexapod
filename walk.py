...
if ser.isOpen():
    ...
    while(True):
        ...
        ser.write("#25P944#26P1056#24P1300#14P2056#1P2056#15P1944#2P1944#13P1578#0P1922T100\r".encode())
        sleep(0.1)
        #down one side A
        ser.write("#26P1166#25P1333#24P1300#13P1578#0P1922#1P1666#14P1666#15P1833#2P1833T100\r".encode())
        sleep(0.1)
        #forward A
        ser.write("#29P1922#24P1500#16P1478#0P1722#8P1300#13P1278T100\r".encode())
        sleep(0.1)
        #up other side A port 8,16,29 gate 2
        ser.write("#30P944#17P944#18P1056#31P1056#29P1422#16P1078#9P2056#10P1944#8P1800T100\r".encode())
        sleep(0.1)
        #down other side A
        ser.write("#31P1166#18P1166#30P1333#17P1333#29P1422#16P1078#8P1800#9P1666#10P1833T100\r".encode())
        sleep(0.1)
        #forward A
