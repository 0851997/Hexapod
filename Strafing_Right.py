...
if ser.isOpen():
    ...
    while(True):
        ...
        ser.write("#26P1255#25P1277 #14P1722#15P1744#1P1722#2P1744 T150\r".encode())
        sleep(0.15)
        # State 1: gait B duwt robot naar rechts
        ser.write("#31P1055#30P1477#18P1055#17P1677 #9P1622#10P1944 T150\r".encode())
        sleep(0.15)
        # State 2: gait A zet poten op een stabiele positie
        ser.write("#26P1055#25P1177 #14P1522#15P1944#1P1322#2P1944 T150\r".encode())
        sleep(0.15)
        # State 3: gait B poten gaat omhoog
        ser.write("#31P1255#30P1277#18P1255#17P1277 #9P1722#10P1744 T150\r".encode())
        sleep(0.15)
        # State 4: gait A trek robot naar rechts
        ser.write("#26P1055#25P1477 #14P1722#15P2044#1P1522#2P2044 T150\r".encode())
        sleep(0.15)
        # State 5: gait B zet poten bij een stabiele positie
        ser.write("#31P955#30P1277#18P955#17P1077 #9P1522#10P2144 T150\r".encode())
        sleep(0.15)
ser.close()
