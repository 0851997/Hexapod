...
if ser.isOpen():
    ...
    while(True):
        ...
        ser.write("#31P1055#30P1477#26P1255#25P1277#18P1055#17P1477 #14P1522#15P1744#9P1722#10P2144#1P1522#2P1744 T50\r".encode())
        sleep(0.05)
        #lynxmotion guide 3 in README
        ser.write("#26P855#25P1277 #14P1322#15P1744#1P1322#2P1744 T50\r".encode())
        sleep(0.05)
