...
if ser.isOpen():
    ...
    while(True):
        ...
        ser.write("#31P1055#30P1477#18P1055#17P1477 #9P1722#10P2144 T400\r".encode())
        sleep(0.40)
        # State 2: gait A zet poten op een stabiele positie
        ser.write("#26P855#25P1277 #14P1522#15P1944#1P1522#2P1944 T400\r".encode())
        sleep(0.40)
        ...
        ser.write("#26P1055#25P1477 #14P1722#15P2144#1P1722#2P2144 T400\r".encode())
        sleep(0.40)
        # State 5: gait B zet poten bij een stabiele positie
        ser.write("#31P855#30P1277#18P855#17P1277 #9P1522#10P1944 T400\r".encode())
        sleep(0.40)
ser.close()
